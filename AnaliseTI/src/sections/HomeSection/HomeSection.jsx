import image_dados from '../../assets/image_dados.webp'

function HomeSection() {
    return (

        <section className="section-main d-flex pt-4 align-items-center bg-white" style={{ minHeight: '90vh' }}>
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-6 mt-5 mt-md-0 d-flex align-items-center justify-content-center">
                        <img 
                            ...
                            style={{ widows: '30rem', height: '20rem', border: '3px solid var(--primary-color)' }}
                        />    
                    </div>  
                </div>
            </div>
